...
//Command Queue Table
$(document).ready(function () {
  var table = $('#commandQueue').DataTable({
    dom:
      "<'row mb-3'<'col-sm-4'l><'col-sm-4'f><'col-sm-4 text-end'B i>>" + // Added B for buttons
      "rt" +
  ...
  table.buttons().container().appendTo('#commandQueue_wrapper .col-sm-4.text-end');
});

//Event Overview
$(document).ready(function () {
  var table = $('#eventOverview11').DataTable({
    dom:
      "<'row mb-3'<'col-sm-4'l><'col-sm-4'f><'col-sm-4 text-end'B i>>" + // Added B for buttons
      "rt" +
      "<'row mt-3'<'col-sm-12'p>>",
...
//Meter Reads
$(document).ready(function () {
  var table = $('#meterReadsTable').DataTable({
    dom:
      "<'row mb-3'<'col-sm-4'l><'col-sm-4'f><'col-sm-4 text-end'B i>>" + // Added B for buttons
      "rt" +
      "<'row mt-3'<'col-sm-12'p>>",
  ...
  table.buttons().container().appendTo('#meterReadsTable .col-sm-4.text-end');
});

//Estimated Reads
$(document).ready(function () {
  var table = $('#estimatedReadsTable').DataTable({
    dom:
      "<'row mb-3'<'col-sm-4'l><'col-sm-4'f><'col-sm-4 text-end'B i>>" + // Added B for buttons
      "rt" +
      "<'row mt-3'<'col-sm-12'p>>",
  ...
  table.buttons().container().appendTo('#estimatedReadsTable .col-sm-4.text-end');
});
